...
Title: "ElabExtDiagnosticReportShowToPatient"
...
* ^url = "http://esveikata.lt/fhir/StructureDefinition/elab-ext-diagnosticReport-showToPatient"
* ^name = "ElabExtDiagnosticReportShowToPatient"
* ^status = #active
* ^date = "2023-02-09"
