...
Title: "ElabExtServiceRequestSpecimenType"
...
* ^url = "http://esveikata.lt/fhir/StructureDefinition/elab-ext-serviceRequest-specimenType"
* ^name = "ElabExtServiceRequestSpecimenType"
* ^status = #active
* ^date = "2023-10-06"
