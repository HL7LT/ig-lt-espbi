...
Title: "ElabExtReferenceOrganizationJar"
...
* url = "http://esveikata.lt/fhir/StructureDefinition/elab-ext-reference-organizationJar"
* name = "ElabExtReferenceOrganizationJar"
* status = "active"
* date = "2023-10-06"
