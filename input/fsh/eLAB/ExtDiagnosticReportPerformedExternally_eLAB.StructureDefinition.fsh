...
Title: "ElabExtDiagnosticReportPerformedExternally"
...
* ^url = "http://esveikata.lt/fhir/StructureDefinition/elab-ext-diagnosticReport-performedExternally"
* ^name = "ElabExtDiagnosticReportPerformedExternally"
* ^status = #active
* ^date = "2023-02-09"
