...
Title: "ElabExtDiagnosticReportRequestedBy"
...
* ^url = "http://esveikata.lt/fhir/StructureDefinition/elab-ext-diagnosticReport-requestedBy"
* ^name = "ElabExtDiagnosticReportRequestedBy"
* ^status = #active
* ^date = "2023-02-09"
