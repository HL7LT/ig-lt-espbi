...
Title: "ElabExtServiceRequestSensitive"
...
* url = "http://esveikata.lt/fhir/StructureDefinition/elab-ext-serviceRequest-sensitive"
* name = "ElabExtServiceRequestSensitive"
* status = "active"
* date = "2023-02-09"
