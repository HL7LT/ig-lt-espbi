...
Extension: LtEspbiExtStatusChangeInformation
Id: LtEspbiExtStatusChangeInformation
Description: "MPP ar medicinos prietaisų išdavimo būsenos keitimo informacija /  MPP or medical device issuance status change information"
Context: DeviceDispense
* ^url = "http://esveikata.lt/fhir/Extension/lt-espbi-ext-status-change-information"
* ^status = #draft
* . 1..1
* . ^short = "MPP ar medicinos prietaisų išdavimo būsenos keitimo informacija /  MPP or medical device issuance status change information"
* . ^definition = "MPP ar medicinos prietaisų išdavimo būsenos keitimo informacija"
* extension contains
    statusWho 1..1 and
    statusWhen 1..1 and
...
* url = "http://esveikata.lt/fhir/Extension/lt-espbi-ext-status-change-information" (exactly)